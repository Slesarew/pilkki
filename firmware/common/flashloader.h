...
//external flash
#define DEBUGGERCMD_EFLASH_INIT_GET_ID  6
#define DEBUGGERCMD_EFLASH_ERASE_PAGE   7
#define DEBUGGERCMD_EFLASH_READ_DATA1   8
#define DEBUGGERCMD_EFLASH_READ_DATA2   9
#define DEBUGGERCMD_EFLASH_WRITE_DATA1  10
#define DEBUGGERCMD_EFLASH_WRITE_DATA2  11

#define SPIPageSize 256
